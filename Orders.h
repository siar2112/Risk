...
#include "Map.h"
#include "Player.h"
#include "AggressiveStrategy.h" //when neutral player is attacked (using BOMB or ADVANCE), the attack order will use neutral player's .setStrategy(AggressiveStrategy* as) method
#include "NeutralStrategy.h"
// #include "HumanStrategy.h" 
// #include "BenevolentStrategy.h" //TODO
// #include "CheaterStrategy.h" //TODO
#include <vector>
#include <string>
using namespace std;
